...
namespace XafIPFS.Blazor.Server {
    public partial class XafIPFSBlazorApplication : BlazorApplication {
        public XafIPFSBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafIPFSBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
